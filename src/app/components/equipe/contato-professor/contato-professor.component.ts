...
@Component({
  selector: 'app-contato-professor',
  templateUrl: './contato-professor.component.html',
  styleUrls: ['./contato-professor.component.scss']
})
export class ContatoProfessorComponent implements OnInit {
  nome: string = '';
  email: string = '';
  mensagem: string = '';
